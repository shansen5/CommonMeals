...
final class Index {
    ...
    public function loadClass($name) {
        $classes = array(
            ...
            'MealAttendeeDao' => '../dao/MealAttendeeDao.php',
            'MealAttendeeMapper' => '../mapping/MealAttendeeMapper.php',
            'MealAttendee' => '../model/MealAttendee.php',
            'MealAttendeeSearchCriteria' => '../dao/MealAttendeeSearchCriteria.php',
